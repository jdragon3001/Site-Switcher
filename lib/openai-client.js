...
class OpenAIClient {
    ...
    async generateContent(prompt, options = {}) {
        const {
            ...
            temperature = 0.7,
            maxTokens = 200,
            systemPrompt = 'You are a professional copywriter. Generate concise, contextually appropriate replacement text. CRITICAL: Output only the replacement text without quotes, quotation marks, formatting, explanations, or any wrapper characters. Return clean, unquoted text only.'
        } = options;
